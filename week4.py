...
Rain=symbols('Rain')
Harry_Visited_Hargid=symbols("Harry_Visited_Hargid")
Harry_Visited_Dumbledore=symbols("Harry_Visited_Dumbledore")
sentence_1=Implies(Not(Rain),Harry_Visited_Hargid)
sentence_2=Xor(Harry_Visited_Hargid,Harry_Visited_Dumbledore)
